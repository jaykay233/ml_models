...
training_samples_file_path = tf.keras.utils.get_file(fname="trainingSamples.csv",
                                                     origin="file:///Users/sabo/PycharmProjects/tensorflow_models/data/trainingSamples.csv")
## Testing samples path
test_samples_file_path = tf.keras.utils.get_file(fname="testSamples.csv",
                                                 origin="file:///Users/sabo/PycharmProjects/tensorflow_models/data/testSamples.csv")
